...
$sql="INSERT INTO project (Fname, Lname, Email, Phone, Hear, Trouble, Troubler, Rate, Recomendation, Comments, Date) VALUES('".$fname."', '".$lname."', '".$email."', '".$phone."', '".$hear."', '".$trouble."', '".$troubler."', '".$rate."', '".$recomendation."', '".$comments."', '".$dt_recd."')";
...
<section class="response">
	...
	<div class="bigcontainer">
		...
		<table widht="40%">
			...
			<tr>
				<td><h2>We appreciate your answers to this survey. This will enable us to</td>
			</tr>
			<tr>
				<td><h2>improve our design and services.</td>
			</tr>
			<tr>
